...
const EventCard = ({ event_id, name, description, register_deadline, start_datetime, end_datetime, entry_fee, location, poster_type, poster_data, signup_link, created_at, single_card }: Prop) => {
    ...
    return (
        <>
            {single_card ? (
                <Fade bottom>
                    <div className="event-card-container single-card" onClick={() => navigate(`/events/${event_id}`)} >
                ...
                <Fade bottom>
                    <div className="event-card-container" onClick={() => navigate(`/events/${event_id}`)} >
                        <div className="poster-container">
                            <img src={`data:${poster_type};base64, ${poster_data}`} alt={`${name} Poster`} />
                        </div>
                        <div className="description-container">
