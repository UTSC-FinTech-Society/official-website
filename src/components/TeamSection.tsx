       ...
       <section className='team-section-container'>
            <div className="white-board" ref={whiteBoardRef} >
                ...
                <TeamGroup name='Vice Presidents' >
                    <ExecutiveCard name='Cassie Xue' position='Vice President of Operations' profilePic={KatelynTam}  />
                ...
                <TeamGroup name='Directors' >
                    <ExecutiveCard name='Dion Chi' position='Director of Operations' profilePic={KatelynTam}  />
